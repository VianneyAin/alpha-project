...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('alphaproxp1.mysql.db', 'alphaproxp1', 'AB27gh74', 'alphaproxp1', '', false, false);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'dbal.dbhost' => 'alphaproxp1.mysql.db',
            'dbal.dbuser' => 'alphaproxp1',
            'dbal.dbpasswd' => 'AB27gh74',
            'dbal.dbname' => 'alphaproxp1',
            'dbal.dbport' => '',
            'dbal.new_link' => false,
        );
    }
