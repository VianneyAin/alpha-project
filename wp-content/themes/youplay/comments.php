...
<div id="comments" class="comments-area comments-block">
	...
	<h3>
		<?php
			printf( // WPCS: XSS OK
				'Comments' . (yp_opts('single_post_comments_count') && have_comments() ? ' <small>(%s)</small>' : ''),
	...
	<?php
		youplay_comment_form(array(
			...
			'comment_field' =>  '<div class="youplay-textarea"><textarea id="comment" placeholder="' . _x( 'Your Comment...', 'youplay', 'youplay' ) . '" name="comment" rows="5" aria-required="true"></textarea></div>',
			'logged_in_as' => '',
