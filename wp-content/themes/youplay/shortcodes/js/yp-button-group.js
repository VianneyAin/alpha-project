    ...
    tinymce.create('tinymce.plugins.YPButtonGroup', {
        init : function(editor, url) {
            editor.addButton('yp_button_group', {
                ...
                icon    : 'fa-square-o',
                onclick : function() {
                    editor.execCommand('mceInsertContent', false, '[yp_button_group]<br>   [yp_button href="http://nkdev.info" size="" full_width="false" active="false" color="success" icon_before="fa fa-html5" icon_after=""]Youplay 1[/yp_button]<br>   [yp_button href="http://nkdev.info" size="" full_width="false" active="false" color="success" icon_before="fa fa-css3" icon_after=""]Youplay 2[/yp_button]<br>[/yp_button_group]');
                }
            });
        },
