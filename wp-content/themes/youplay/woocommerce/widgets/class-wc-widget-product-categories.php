...
class yp_WC_Widget_Product_Categories extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = __( 'A list or dropdown of product categories.', 'youplay' );
		$this->widget_id          = 'woocommerce_product_categories';
		$this->widget_name        = __( 'WooCommerce Product Categories', 'youplay' );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => __( 'Product Categories', 'youplay' ),
			...
			'orderby' => array(
				...
				'options' => array(
					'order' => __( 'Category Order', 'youplay' ),
					'name'  => __( 'Name', 'youplay' )
				)
			),
			'dropdown' => array(
				'type'  => 'checkbox',
				'std'   => 0,
				'label' => __( 'Show as dropdown', 'youplay' )
			),
			'count' => array(
				'type'  => 'checkbox',
				'std'   => 0,
				'label' => __( 'Show product counts', 'youplay' )
			),
			'hierarchical' => array(
				'type'  => 'checkbox',
				'std'   => 1,
				'label' => __( 'Show hierarchy', 'youplay' )
			),
			'show_children_only' => array(
				'type'  => 'checkbox',
				'std'   => 0,
				'label' => __( 'Only show children of the current category', 'youplay' )
			)
		);
	...
	public function widget( $args, $instance ) {
		...
		// List
			...
			$list_args['show_option_none']           = __('No product categories exist.', 'youplay' );
