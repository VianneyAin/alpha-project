...
$side = strpos(yp_opts('single_product_layout', true), 'side-cont') !== false
                    ? 'left'
                    : (strpos(yp_opts('single_product_layout', true), 'cont-side') !== false
                      ? 'right'
                      : false);
...
get_header( 'shop' ); ?>
    ...
    <?php while ( have_posts() ) : the_post();
        ...
        <section class="content-wrap <?php echo ($banner||$rev_slider?'':'no-banner'); ?>">
            ...
            <div class="<?php echo ($boxed_cont?'container':''); ?> youplay-store">
                <?php
