			    ...
			    <div class="col-lg-10 col-md-9 col-xs-8">
			      <div class="row">
			        ...
			        <div class="col-xs-6 col-md-3 align-right">
			          ...
			          <?php
			            echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf( '<a href="%s" class="glyphicon glyphicon-remove" style="font-size: 1.7rem; margin-top: 5px; margin-right: 20px; text-decoration: none;" title="%s"></a>', esc_url( WC()->cart->get_remove_url( $cart_item_key ) ), __( 'Remove this item', 'youplay' ) ), $cart_item_key );
			          ?>
			        </div>
			      </div>
			    </div>
