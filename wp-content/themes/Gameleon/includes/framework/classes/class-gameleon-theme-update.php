<?php
if (!class_exists("GameleonThemeUpdate")) {
	class GameleonThemeUpdate {
		...
		public function check($updates) {
			...
			$this->username = apply_filters("gameleon_theme_update_username",$this->username);
			$this->apiKey = apply_filters("gameleon_theme_update_apiKey",$this->apiKey);
			$this->authors = apply_filters("gameleon_theme_update_authors",$this->authors);
		...
		public static function init($username = null,$apiKey = null,$authors = null) {
			new GameleonThemeUpdate($username,$apiKey,$authors);
		}
