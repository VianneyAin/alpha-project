...
if( !defined('ADMIN_PATH') )
	define( 'ADMIN_PATH', get_template_directory() . '/includes/framework/' );
...
add_action('admin_notices', 'optionsframework_activation_notice');
add_action( 'admin_head', 'optionsframework_hide_activation' );
...
/*----------------------------------------------------------------------------------------------------------
	Auto Update the theme from admin dashboard
-----------------------------------------------------------------------------------------------------------*/

$template_directory = get_template_directory();

if ( gameleon_get_option( 'td_themeforest_username' ) != '' AND gameleon_get_option( 'td_themeforest_api_key' ) != '' ) {

	$username 	= gameleon_get_option( 'td_themeforest_username' );
	$apikey 	= gameleon_get_option( 'td_themeforest_api_key' );
	$author 	= 'Tiguan';

	require_once $template_directory . '/includes/framework/classes/class-gameleon-theme-update.php';
	GameleonThemeUpdate::init($username,$apikey,$author);
