...
/*----------------------------------------------------------------------------------------------------------
	Gameleon_Ad_300 Widget class
-----------------------------------------------------------------------------------------------------------*/
class Gameleon_Ad_300 extends WP_Widget {
...
public function __construct() {
	parent::__construct(
		'gameleon_ad_300',
		__( '[GAMELEON] 300x250 Ad', 'gameleon' ),  // Widget Name
		array( 'description' => __( 'Displays a 300x250 banner on sidebar', 'gameleon' ), ) // Widget Args
		);
}
...
public function widget( $args, $instance ) {
	...
	<?php
	if( $image ) : ?>
		<div class="td-banner-300">
			<a href="<?php echo $link; ?>"><img src="<?php echo $image; ?>" alt="<?php echo $alt; ?>" /></a>
		</div>
	<?php else : ?>
		<div class="td-banner-300"><?php echo stripslashes( $code ); ?></div>
	<?php endif ; ?>
...
/*----------------------------------------------------------------------------------------------------------
  Register Gameleon_Ad_300 widget
-----------------------------------------------------------------------------------------------------------*/

function gameleon_ad_300_init(){
	register_widget( 'Gameleon_Ad_300' );
}

add_action( 'widgets_init', 'gameleon_ad_300_init' );