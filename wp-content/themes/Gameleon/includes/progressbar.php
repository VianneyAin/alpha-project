...
function loadgame(wait_time) {
  ...
  var percentlimit = <?php echo gameleon_get_option( 'td_bar_textload_limit' ); ?>;
  var speedindex = <?php echo gameleon_get_option( 'td_bar_speed' ); ?>;
  var percentlimitstatus = "<?php echo gameleon_get_option( 'td_bar_textload_status' ); ?>";
