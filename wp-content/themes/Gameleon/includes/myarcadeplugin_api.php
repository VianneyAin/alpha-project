...
if ( !function_exists('myarcade_thumbnail')) {
  ...
  */
  function myarcade_thumbnail ($width = 140, $height = 80, $class = '') {
    global $post;
    ...
    if ( preg_match('|^(http).*|i', $thumbnail) == 0 ) {
      ...
      $thumbnail = get_template_directory_uri().'/images/placeholders/90x59.png';
...
if ( !function_exists( 'myarcade_featured_image' ) ) {
   ...
   * Function added for the Gameleon theme
   *
