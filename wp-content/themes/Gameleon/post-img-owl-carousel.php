...
<?php $image = '<a href="' . get_permalink() . '">' . get_the_post_thumbnail( get_the_ID(), 'module-carousel' ) . '</a>'; ?>
<?php if ( empty( $image[0] ) ) { $image[0] = myarcade_get_thumbnail_url (); } ?>
<?php echo $image; ?>
<?php else: // show image placeholder?>
<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
<img src="<?php echo get_template_directory_uri(); ?>/images/placeholders/90x59.png" width="90" height="59" alt="<?php the_title(); ?>" />
</a>
