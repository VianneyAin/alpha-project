...
<?php
// get "orderby" option
$post_orderby_filter = gameleon_get_option( 'td_all_posts_orderby' );
// get "order" option
$post_order_filter = gameleon_get_option( 'td_all_posts_order' );
// meta_key
...
$exclude_from_all_posts = gameleon_get_option( 'td_all_posts_exclude' );
$exclude_from_all_posts = explode(',',$exclude_from_all_posts); //break the string into array keys

$all_posts_query = new WP_Query( array(  'category__not_in' => $exclude_from_all_posts, 'orderby' => $post_orderby_filter, 'order' => $post_order_filter, 'meta_key' => $td_metakey, 'paged' => $paged ) );
$temp_query = $wp_query;
$wp_query = null;
