...
function taq_admin_register() {
    wp_register_script( 'taqyeem-admin-slider',  plugins_url('admin/js/jquery.ui.slider.js' , __FILE__), array('jquery' ) , false , false );  
    wp_register_script( 'taqyeem-admin-checkbox', plugins_url('admin/js/checkbox.min.js' , __FILE__) , array( 'jquery' ) , false , false );  
    wp_register_script( 'taqyeem-admin-main', plugins_url('admin/js/tie.js' , __FILE__), array( 'jquery', 'jquery-ui-core', 'jquery-ui-widget', 'jquery-ui-mouse', 'jquery-ui-sortable' ) , false , false );  
