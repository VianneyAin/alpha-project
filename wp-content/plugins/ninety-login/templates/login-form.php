...
<p><label for="nd_username"><?php _e('Username','gameleon'); ?>:</label> <input type="text" class="text" name="log" id="nd_username" placeholder="<?php _e('Username', 'gameleon'); ?>" /></p>
<p><label for="nd_password"><?php _e('Password','gameleon'); ?>:</label> <input type="password" class="text" name="pwd" id="nd_password" placeholder="<?php _e('Password','gameleon'); ?>" /></p>
<p>


<a class="forgotten" href="#nd_lost_password_form"><?php _e('You can\'t login?','gameleon'); ?></a> <input type="submit" class="button" value="<?php _e( 'Log in &rarr; ', 'gameleon' ); ?>" />
